...
import InfoView from '../../../@gotrust/core/InfoView';
...
const SigninJwtAuth: React.FC<UserSigninProps> = props => {
  ...
  const { error } = useSelector<AppState, AppState['common']>(({ common }) => common);

  useEffect(() => {
    if (error === "Invalid Credentials") {
      Swal.fire({
        title: "Thông báo",
        text: "Tài khoản hoặc mật khẩu không chính xác. Xin vui lòng thử lại !",
        icon: "warning",
