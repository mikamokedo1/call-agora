...
const ComingSoon = () => {
  ...
  return (
    <AppAnimate animation="transition.slideUpIn" delay={200}>
      ...
      >
        <Box>
          <Box component="h3" mb={{ xs: 4, xl: 10 }} fontSize={{ xs: 20, md: 24 }} fontWeight={Fonts.BOLD}>
            <IntlMessages id="error.comingSoon" />!
          </Box>
          <Box mb={{ xs: 5, xl: 12 }} color={grey[600]} fontWeight={Fonts.MEDIUM} fontSize={16}>
            <Typography>
          ...
          <Box mb={5} maxWidth={{ xs: 300, sm: 400, xl: 672 }} width="100%">
            <img src="/assets/images/errorPageImages/comingsoon.png" alt="404" />
          </Box>
        </Box>
        <InfoView />
      </Box>
