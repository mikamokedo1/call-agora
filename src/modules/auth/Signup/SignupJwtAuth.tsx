...
const SignupFirebase: React.FC<{}> = () => {
  ...
  const validationSchema = yup.object({
    ...
    password: yup.string().required(messages['validation.passwordRequired'] as string),
    confirmPassword: yup.string().required(messages['validation.reTypePassword'] as string),
  });
            ...
            <Form className={classes.formRoot} noValidate autoComplete="off">
              ...
              <Box mb={{ xs: 3, xl: 4 }} display="flex" alignItems="center" fontSize={15}>
                <Box display="flex" alignItems="center">
                  ...
                  <Box className={classes.textGrey} component="span" mr={2} fontSize={15}>
                    <IntlMessages id="common.iAgreeTo" />
                  </Box>
                </Box>
                <Box color="primary.main" component="span" fontSize={15} className={classes.pointer}>
              ...
              >
                ...
                <Box ml={{ sm: 4 }} mt={{ xs: 3, sm: 0 }} color="text.secondary" fontSize={15}>
                  <Box className={classes.textGrey} component="span" mr={1}>
                    <IntlMessages id="common.alreadyHaveAccount" />
                  </Box>
                  <Box component="span">
                    <Link to="/signin" className={clsx(classes.underlineNone, classes.colorTextPrimary)}>
