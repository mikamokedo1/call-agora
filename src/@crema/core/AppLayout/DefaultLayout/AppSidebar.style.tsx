...
const useStyles = makeStyles((theme: CremaTheme) => {
  return {
    ...
    sidebarBg: {
      overflow: 'hidden',
      backgroundColor: (props: { themeStyle: ThemeStyle; themeMode: ThemeMode }) =>
    ...
    scrollAppSidebar: {
      ...
      height: (props: { themeStyle: ThemeStyle; themeMode: ThemeMode }) =>
        props.themeStyle === ThemeStyle.MODERN ? 'calc(100vh - 166px) !important' : 'calc(100vh - 116px) !important',
      [theme.breakpoints.up('xl')]: {
        height: (props: { themeStyle: ThemeStyle; themeMode: ThemeMode }) =>
          props.themeStyle === ThemeStyle.MODERN ? 'calc(100vh - 190px) !important' : 'calc(100vh - 130px) !important',
      },
    },
