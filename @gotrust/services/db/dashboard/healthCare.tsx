  ...
  hospitalStatics: [
    {
      ...
      value: '3,256',
      name: 'Total Patient',
      icon: '/images/dashboard/icon-patient.png',
    },
    {
      id: 2,
      value: '694',
      name: 'Available Staff',
      icon: '/images/dashboard/icon-available-staff.png',
    },
    {
      id: 3,
      value: '$4,435',
      name: 'Avg Treat Cost',
      icon: '/images/dashboard/icon-avg-cost.png',
    },
    {
      id: 4,
      value: '1,150',
      name: 'Available Cars',
      icon: '/images/dashboard/icon-available-car.png',
    },
  ],
  recentPatients: [
    {
  ...
  bloodCard: [
    {
      id: 1,
      name: 'Blood Pressure',
      icon: '/images/dashboard/icon-blood.png',
    ...
    },
    {
      id: 2,
      name: 'Blood Glucose',
      icon: '/images/dashboard/icon-bloodgroup.png',
    ...
    },
    {
      ...
      icon: '/images/dashboard/icon-beat.png',
    ...
    },
    {
      id: 4,
      name: 'Immunity Rate',
      icon: '/images/dashboard/icon-immune.png',
      measurement: '4800 μL',
      color: '#2717A4',
    },
  ],
  appointmentCards: [
    {
      ...
      value: '1878',
      icon: '/images/dashboard/icon-appointment.png',
      chartValue: '2.68',
    ...
    },
    {
      ...
      name: 'Surgery',
      value: '1878',
      icon: '/images/dashboard/icon-surgery.png',
      chartValue: '2.68',
      chartTime: 'Since last month',
      chartData: [
        {month: 'Jan', users: 1000},
  ...
  doses: [
    {
      ...
      icon: '/images/dashboard/icon-vitamin.png',
    },
    {
      id: 2,
      value: 'Immune Renew',
